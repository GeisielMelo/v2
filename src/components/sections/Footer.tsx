import { GitHub, LinkedIn, WhatsApp, LightMode, DarkMode } from '@mui/icons-material'
  ...
  return (
    <footer className='text-white py-4 font-inter text-sm dark:bg-black'>
      ...
      <div className='w-full flex justify-center py-4'>
        <p
          className='max-w-max px-2 text-zinc-700 ease-in-out duration-300 hover:cursor-pointer hover:text-cyan-400'
          onClick={() => openNewTab(config.url.github)}
        >
