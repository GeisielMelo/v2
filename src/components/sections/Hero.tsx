    ...
    <section id='#' className='flex flex-col h-screen justify-center text-white max-w-5xl w-full p-12 border border-zinc-700 transition-all font-inter'>
      ...
      <UpMotion delay={0.6}>
        <p className='text-[clamp(9px,5vw,16px)] mt-6 max-w-xl leading-tight text-zinc-600'>
          ...
          With a special focus on creating accessible and user-centric
          solutions, I am committed to building products that stand out and
          provide amazing experiences for users.
        </p>
      </UpMotion>
    </section>
  )
