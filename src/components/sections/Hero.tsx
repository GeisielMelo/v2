const Hero: React.FC = () => {
  return (
    <section
      id='#'
      className='flex flex-col h-screen justify-center text-white max-w-5xl w-full p-12 border border-zinc-700 transition-all font-inter'
    >
      ...
      <p className='text-[clamp(9px,5vw,16px)] mt-6 max-w-xl leading-tight'>
